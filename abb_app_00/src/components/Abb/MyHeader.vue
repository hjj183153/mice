    ...
    <div id="my-header">
        ...
        <el-menu :default-active="activeIndex" class="el-menu-demo floatright"  mode="horizontal" @select="handleSelect">
            ...
            <el-submenu index="2">
                ...
                <el-menu-item index="2-1"><img src="" alt=""></el-menu-item>
